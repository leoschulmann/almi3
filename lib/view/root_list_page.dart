...
class RootListPage extends ConsumerWidget {
  const RootListPage({super.key});

  
  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final RootListPageState pageState = ref.watch(rootListPageProvider);
  ...
  PreferredSizeWidget _buildAppBar(BuildContext context, RootListPageState state) {
  ...
  Widget _buildBody(BuildContext context, WidgetRef ref, RootListPageState state) {
